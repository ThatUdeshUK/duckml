...
struct LlmMaxTokensSetting {
    ...
    static constexpr const char *Description = "Max token size used by LMs";
    static constexpr const char *InputType = "UBIGINT";
    static void SetLocal(ClientContext &context, const Value &parameter);
    static void ResetLocal(ClientContext &context);
    static Value GetSetting(const ClientContext &context);
...
struct LlmNoThreadsSetting {
    ...
    static constexpr const char *Description = "Batch size for ML/LLM inference";
    static constexpr const char *InputType = "UBIGINT";
    static void SetLocal(ClientContext &context, const Value &parameter);
    static void ResetLocal(ClientContext &context);
    static Value GetSetting(const ClientContext &context);
...
struct LlmUseBatchSetting {
    ...
    static constexpr const char *Description = "Toggle to enable/disable row marshaling of LLM calls";
    static constexpr const char *InputType = "BOOLEAN";
    static void SetLocal(ClientContext &context, const Value &parameter);
    static void ResetLocal(ClientContext &context);
    static Value GetSetting(const ClientContext &context);
...
struct LlmUseCacheSetting {
    ...
    static constexpr const char *Description = "Toggle to enable/disable deduplication";
    static constexpr const char *InputType = "BOOLEAN";
    static void SetLocal(ClientContext &context, const Value &parameter);
    static void ResetLocal(ClientContext &context);
    static Value GetSetting(const ClientContext &context);
...
struct ModelSelectStrategySetting {
    using RETURN_TYPE = string;
    static constexpr const char *Name = "model_select_strategy";
    static constexpr const char *Description = "Strategy for model selection";
    static constexpr const char *InputType = "VARCHAR";
    static void SetLocal(ClientContext &context, const Value &parameter);
    static void ResetLocal(ClientContext &context);
    static Value GetSetting(const ClientContext &context);
...
struct OnnxExecutionModeSetting {
    ...
    static constexpr const char *Description = "Execution model for ONNX";
    static constexpr const char *InputType = "UBIGINT";
    static void SetLocal(ClientContext &context, const Value &parameter);
    static void ResetLocal(ClientContext &context);
    static Value GetSetting(const ClientContext &context);
...
struct OnnxInterTcSetting {
    ...
    static constexpr const char *Description = "Inter thread count used by ONNX";
    static constexpr const char *InputType = "UBIGINT";
    static void SetLocal(ClientContext &context, const Value &parameter);
    static void ResetLocal(ClientContext &context);
    static Value GetSetting(const ClientContext &context);
...
struct OnnxIntraTcSetting {
    ...
    static constexpr const char *Description = "Intra thread count used by ONNX";
    static constexpr const char *InputType = "UBIGINT";
    static void SetLocal(ClientContext &context, const Value &parameter);
    static void ResetLocal(ClientContext &context);
    static Value GetSetting(const ClientContext &context);
...
struct PullPredictFilterSetting {
    ...
    static constexpr const char *Description = "Toggle to enable/disable predict pullup optimization";
    static constexpr const char *InputType = "BOOLEAN";
    static void SetLocal(ClientContext &context, const Value &parameter);
    static void ResetLocal(ClientContext &context);
    static Value GetSetting(const ClientContext &context);
