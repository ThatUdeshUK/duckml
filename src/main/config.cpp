...
static const ConfigurationOption internal_options[] = {
    ...
    DUCKDB_LOCAL(ModelSelectStrategySetting),
    DUCKDB_LOCAL(ModelSelectQualityWeightSetting),
    DUCKDB_LOCAL(ModelSelectCostWeightSetting),
    DUCKDB_LOCAL(ModelSelectTimeWeightSetting),
    DUCKDB_LOCAL(ModelSelectMinQualitySetting),
    DUCKDB_LOCAL(ModelSelectMaxCostSetting),
    DUCKDB_LOCAL(ModelSelectMaxTimeSetting),
