...
SELECT p.PRODUCT_NAME, STORE_PRICE, LLM o4mini (PROMPT 'has the {{STORE_PRICE}} of {{p.PRODUCT_NAME}} gone up or {gone_down BOOLEAN} from the release date dollar price')
FROM Product AS p
